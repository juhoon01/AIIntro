...
class sixLayerNet:
    ...
    def __init__(self, input_size, hidden_size1, hidden_size2, hidden_size3, hidden_size4, hidden_size5, output_size, weight_init_std=0.1):
        # 가중치 초기화
        self.params = {}
        ...
        self.layers['BatchNorm5'] = BatchNormalization(self.gamma5, self.beta5)
